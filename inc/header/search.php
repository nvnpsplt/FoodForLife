...
class Search {
	...
	public static function get_trending() {
		...
		$trending_searches = (array) apply_filters( 'foodforlife_search_trending', Helper::get_option( 'header_search_links' ) );
		...
		<div class="header-search__trending">
			<h5 class="header-search__suggestion-label mt-0 mb-15"><?php esc_html_e( 'Trending Search', 'foodforlife' ); ?></h5>
			<ul class="header-search__trending-links list-unstyled d-flex flex-wrap gap-10 align-items-center">
				...
				foreach ( $trending_searches as $trending_search ) {
					...
					printf(
						'<li><a class="ffl-button ffl-button-outline" href="%s">%s</a></li>',
					...
					?>
						<li class="d-flex">
							<div class="suggest-list__image">
								<a class="suggest-list__link ffl-ratio" href="<?php echo esc_url( get_permalink( $id )); ?>">
