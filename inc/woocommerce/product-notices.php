...
class Product_Notices {
    ...
    public function __construct() {
        add_filter( 'foodforlife_wp_script_data', array( $this, 'notices_script_data' ) );
   }
    ...
    public function notices_script_data( $data ) {
        ...
        if ( intval( Helper::get_option( 'added_to_wishlist_notice' ) ) && shortcode_exists( 'wcboost_wishlist_button' ) ) {
            ...
            $data['added_to_wishlist_notice'] = array(
                'added_to_wishlist_text'    => esc_html__( 'has been added to your wishlist.', 'foodforlife' ),
                'added_to_wishlist_texts'   => esc_html__( 'have been added to your wishlist.', 'foodforlife' ),
                'wishlist_view_text'        => esc_html__( 'View Wishlist', 'foodforlife' ),
        ...
        // REMOVED: Compare notification — feature disabled.
        ...
        //         'added_to_compare_text'    => esc_html__( 'has been added to your compare.', 'foodforlife' ),
        //         'added_to_compare_texts'   => esc_html__( 'have been added to your compare.', 'foodforlife' ),
        //         'compare_view_text'        => esc_html__( 'View Compare', 'foodforlife' ),
