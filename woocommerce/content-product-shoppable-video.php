...
<div class="<?php echo esc_attr( implode( ' ', $classes ) ); ?>">
	<div class="product-gallery-summary position-relative d-flex flex-column flex-md-row gap-30">
		...
		<div class="summary entry-summary">
			<?php
			/**
			 * Hook: foodforlife_woocommerce_product_shoppable_video_summary
			 *
			 ...
			 */
			do_action( 'foodforlife_woocommerce_product_shoppable_video_summary' );
			?>
		</div>

		<?php
		/**
		 * Hook: foodforlife_woocommerce_after_product_shoppable_video_summary
		 */
		do_action( 'foodforlife_woocommerce_after_product_shoppable_video_summary' );
		?>
	</div>
</div>