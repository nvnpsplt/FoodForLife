...
class Languages extends Widget_Base {
	...
	public function get_title() {
		return __( '[FoodForLife] Languages', 'foodforlife-addons' );
	}
	...
	public function get_keywords() {
		return [ 'language', 'languages', 'foodforlife-addons' ];
	}
	...
	public function get_style_depends() {
		return [ 'foodforlife-currency-language-css' ];
	}
	...
	protected function render() {
		$this->add_render_attribute( 'wrapper', 'class', [ 'foodforlife-language-elementor', 'foodforlife-currency-language-elementor', 'foodforlife-currency-language' ] );
		...
		<div <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>
			<?php echo \FoodForLife\WooCommerce\Language::language_switcher(); ?>
		</div>
		<?php
	}
}