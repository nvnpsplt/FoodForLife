...
class SetupSettings {
	...
	public function clear_font_cache() {
		...
		include_once ABSPATH . 'wp-admin/includes/class-wp-filesystffl-base.php';
		include_once ABSPATH . 'wp-admin/includes/class-wp-filesystffl-direct.php';
		...
		if ( is_dir( $fonts_dir ) ) {
			...
			$file_systffl->rmdir( $fonts_dir, true );
		} else {
