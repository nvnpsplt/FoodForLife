...
class Post_Type {
	...
	public function register_post_type() {
		...
		register_post_type( self::POST_TYPE, array(
			'description'         => esc_html__( 'Buy X Get Y', 'foodforlife-addons' ),
			'labels'              => array(
				'name'                  => esc_html__( 'Buy X Get Y', 'foodforlife-addons' ),
				'singular_name'         => esc_html__( 'Buy X Get Y', 'foodforlife-addons' ),
				'menu_name'             => esc_html__( 'Buy X Get Y', 'foodforlife-addons' ),
				'all_items'             => esc_html__( 'Buy X Get Y', 'foodforlife-addons' ),
