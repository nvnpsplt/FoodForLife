...
<nav class="navigation post-navigation mt-50 py-30 border-top d-flex gap-15 <?php echo esc_attr( $class ); ?>" role="navigation">
	<?php if ( $prev_post ) : ?>
		<a class="nav-previous d-flex flex-column flex-1" href="<?php echo esc_url( get_permalink( $prev_post ) ) ?>">
			<span class="ffl-button ffl-button-text justify-content-start align-items-center gap-10 text-base lh-1">
				<?php echo \FoodForLife\Icon::inline_svg('icon=icon-back'); ?>
				<span class="nav-label text-uppercase fs-13 lh-1"><?php esc_html_e( 'Previous Post', 'foodforlife' );?></span>
			</span>
	...
	<?php if ( $next_post ) : ?>
		<a class="nav-next d-flex flex-column align-items-end flex-1" href="<?php echo esc_url( get_permalink( $next_post ) )  ?>">
			<span class="ffl-button ffl-button-text justify-content-end align-items-center gap-10 text-base lh-1">
				<span class="nav-label text-uppercase fs-13 lh-1"><?php esc_html_e( 'Next Post', 'foodforlife' );?></span>
				<?php echo \FoodForLife\Icon::inline_svg('icon=icon-next'); ?>
			</span>
