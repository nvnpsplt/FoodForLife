...
namespace FoodForLife\Languages;
...
class WPML {
	...
	public function __construct() {
		...
		add_filter( 'foodforlife_campaign_item_args', array( $this, 'translate_campaign_item_args' ), 10, 2 );
		add_filter( 'foodforlife_topbar_slides', array( $this, 'translate_topbar_slides' ) );
		add_filter( 'foodforlife_search_trending', array( $this, 'translate_search_quicklinks' ) );
		add_filter( 'foodforlife_product_shipping_promotions_list', array( $this, 'translate_product_shipping_promotions_list' ) );
