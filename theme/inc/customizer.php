...
class Customizer {
	...
	public function __construct( $config = array()) {
		$this->config = apply_filters( 'foodforlife_customize_config', $config );
	...
	public function enqueue_preview_scripts() {
		...
		wp_enqueue_script( 'foodforlife-customizer-preview', get_template_directory_uri() . '/assets/js/backend/customizer-preview.js', array( 'customize-preview' ), '', true );
	}
