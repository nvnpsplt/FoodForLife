...
class Category_Settings {
	...
	public function register_admin_scripts( $hook ) {
		...
		if ( ( $hook == 'edit-tags.php' &&  $screen->taxonomy == 'product_cat' ) || ( $hook == 'term.php' &&  $screen->taxonomy == 'product_cat' ) ) {
			wp_enqueue_media();
			wp_enqueue_script( 'foodforlife_product_cat_js', get_template_directory_uri() . "/assets/js/backend/product-cat.js", array( 'jquery' ), '20250329', true );
		}
	}
	...
	public function add_category_fields() {
		...
		<div class="form-field">
            <label><?php esc_html_e( 'Page Header Background', 'foodforlife' ); ?></label>

            <div id="gz_page_header_bg" class="ffl-page-header-bg">
                <ul class="ffl-cat-page-header-bg"></ul>
                <input type="hidden" id="gz_page_header_bg_id" class="gz_page_header_bg_id" name="gz_page_header_bg_id"/>
                <button type="button"
                        data-delete="<?php esc_attr_e( 'Delete image', 'foodforlife' ); ?>"
                        data-text="<?php esc_attr_e( 'Delete', 'foodforlife' ); ?>"
                        class="upload_images_button button"><?php esc_html_e( 'Upload/Add Image', 'foodforlife' ); ?></button>
            </div>
            <div class="clear"></div>
        </div>
		<?php if(\FoodForLife\Helper::get_option('product_grid_banner')) : ?>
			<hr/>
			<div class="form-field">
				<label><?php esc_html_e( 'Product Grid Banner', 'foodforlife' ); ?></label>

				<div id="gz_cat_product_banner" class="ffl-cat-shop-banner">
					<ul class="ffl-cat-images"></ul>
			...
			<div class="form-field">
				<label><?php esc_html_e( 'Product Grid Banner Link', 'foodforlife' ); ?></label>

				<div class="ffl-cat-shop-banner-link">
					<input type="text" id="gz_cat_product_banner_link" name="gz_cat_product_banner_link" />
				</div>
				<div class="clear"></div>
			</div>
			<div class="form-field">
				<label><?php esc_html_e( 'Product Grid Banner Position', 'foodforlife' ); ?></label>

				<div class="ffl-cat-shop-banner-position">
	...
	public function edit_category_fields( $term ) {
		...
		<tr class="form-field">
            <th scope="row" valign="top"><label><?php esc_html_e( 'Page Header Background', 'foodforlife' ); ?></label></th>
            <td>
                <div id="gz_page_header_bg" class="ffl-page-header-bg">
                    <ul class="ffl-cat-page-header-bg">
						<?php
						...
						if ( $page_header_bg_id ) {
							...
							<li class="image" data-attachment_id="<?php echo esc_attr( $page_header_bg_id ); ?>">
								...
								<ul class="actions">
									<li>
										<a href="#" class="delete"
											title="<?php esc_attr_e( 'Delete image', 'foodforlife' ); ?>"><?php esc_html_e( 'Delete', 'foodforlife' ); ?></a>
									</li>
								</ul>
							</li>
							<?php
		...
		<?php if(\FoodForLife\Helper::get_option('product_grid_banner')) : ?>
        <tr class="form-field">
            <th scope="row" valign="top"><label><?php esc_html_e( 'Product Grid Banner', 'foodforlife' ); ?></label></th>
            <td>
                <div id="gz_cat_product_banner" class="ffl-cat-shop-banner">
                    <ul class="ffl-cat-image">
						<?php
        ...
        <tr class="form-field">
            <th scope="row" valign="top"><label><?php esc_html_e( 'Product Grid Banner Link', 'foodforlife' ); ?></label></th>
            <td>
                <div class="ffl-cat-shop-banner-link">
		...
		<tr class="form-field">
            <th scope="row" valign="top"><label><?php esc_html_e( 'Product Grid Banner Position', 'foodforlife' ); ?></label></th>
            <td>
                <div class="ffl-cat-shop-banner-position">
