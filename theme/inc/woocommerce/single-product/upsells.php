...
class UpSells {
	...
	public function __construct() {
		if ( ! intval( \FoodForLife\Helper::get_option( 'upsells_products' ) ) ) {
	...
	public function upsells_title() {
		return esc_html__( 'People Also Bought', 'foodforlife' );
	}
	...
	public function upsells_total( $limit ) {
		$limit = \FoodForLife\Helper::get_option('upsells_products_numbers');
