...
class Layout {
	...
	public function __construct() {
		...
		// Sidebar
		add_filter( 'foodforlife_site_layout', array( $this, 'layout' ), 55 );
		add_filter( 'foodforlife_get_sidebar', array( $this, 'sidebar' ), 10 );

		add_filter( 'foodforlife_primary_sidebar_classes', array( $this, 'sidebar_classes' ), 10 );
	...
	public function body_class( $classes ) {
		$classes[] = 'foodforlife-catalog-page';
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_style( 'foodforlife-catalog', apply_filters( 'foodforlife_get_style_directory_uri', get_template_directory_uri() ) . '/assets/css/woocommerce/catalog' . $debug . '.css', array(), \FoodForLife\Helper::get_theme_version() );
	}
	...
	public function script_data( $data ) {
		$data['shop_nav_ajax_url_change']    = \FoodForLife\Helper::get_option( 'product_catalog_pagination_ajax_url_change' );
