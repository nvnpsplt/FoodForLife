...
<div class="<?php echo esc_attr( implode( ' ', $classes ) ); ?>">
	<div class="product-gallery-summary position-relative d-flex flex-column flex-md-row gap-30">
		<?php
		/**
		 * Hook: foodforlife_woocommerce_before_product_summary_summary
		 *
		 * @hooked woocommerce_show_product_images - 10
		 */
		do_action( 'foodforlife_woocommerce_before_product_summary' );
		?>

		<div class="summary entry-summary">
			<?php
			/**
			 * Hook: foodforlife_woocommerce_product_summary_summary
			 *
			 ...
			 */
			do_action( 'foodforlife_woocommerce_product_summary' );
			?>
		</div>

		<?php
		/**
		 * Hook: foodforlife_woocommerce_after_product_summary_summary
		 */
		do_action( 'foodforlife_woocommerce_after_product_summary' );
		?>
	</div>
</div>