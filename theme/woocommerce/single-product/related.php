...
?>
	...
	<section class="related products">
		...
		<?php if( ! empty( \FoodForLife\Helper::get_option( 'related_products_description' ) ) ) : ?>
			<p class="related-products__description"><?php echo \FoodForLife\Helper::get_option( 'related_products_description' ); ?></p>
		<?php endif; ?>

		<div class="foodforlife-product-carousel swiper foodforlife-swiper navigation-class--tabletdots navigation-class--mobiledots ffl-arrows-middle <?php echo in_array( 'related', $slides_per_view_auto ) ? 'slides-per-view-auto--mobile' : ''; ?>" data-swiper="<?php echo esc_attr( json_encode( $args_swiper ) ); ?>" data-desktop="<?php echo esc_attr($args_swiper['slidesPerView']['desktop']); ?>" data-tablet="<?php echo esc_attr($args_swiper['slidesPerView']['tablet']); ?>" data-mobile="<?php echo esc_attr($args_swiper['slidesPerView']['mobile']); ?>" style="--ffl-swiper-auto-width-mobile: 64%;--ffl-swiper-auto-fluid-end-mobile: 15px;">
