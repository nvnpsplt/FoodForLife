...
(function ($) {
    ...
    $.fn.foodforlife_countdown = function () {
    ...
    /* Init tabs */
    $(function () {
        $(document.body).find('.foodforlife-countdown').foodforlife_countdown();

        $(document.body).on('foodforlife_countdown', function (e, el) {
            clearCountdownInterval(el);
            $(el).foodforlife_countdown();
        });
    });
