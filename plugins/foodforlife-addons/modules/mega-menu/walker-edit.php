			...
			<div class="menu-item-bar">
				<div class="menu-item-handle">
					<label class="item-title" for="menu-item-checkbox-<?php echo $item_id; ?>">
						...
						<span class="is-submenu" style="display: none;"><?php _e( 'sub item', 'foodforlife-addons' ); ?></span>
					</label>
					<span class="item-controls">
						...
						printf(
							...
							$item_id,
							$edit_url,
							esc_attr__( 'Edit menu item', 'foodforlife-addons' ),
			...
			<div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
				...
				if ( $widget ) {
					...
					$widget->print_control( array(
						'type'        => 'text',
						'label'       => __( 'CSS Classes (optional)', 'foodforlife-addons' ),
						'name'        => 'classes',
