...
class Heading extends Widget_Base {
	...
	public function get_title() {
		return __( '[FoodForLife] Heading', 'foodforlife-addons' );
	}
	...
	public function get_keywords() {
		return [ 'heading', 'title', 'text', 'foodforlife-addons' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Add Your Heading Text Here', 'foodforlife-addons' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'normal'  => __( 'Normal', 'foodforlife-addons' ),
					'medium'  => __( 'Medium', 'foodforlife-addons' ),
					'large'   => __( 'Large', 'foodforlife-addons' ),
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'options'              => [
					...
					'space-between' => [
						'title' => __( 'Between', 'foodforlife-addons' ),
						'icon' => 'eicon-justify-space-between-h',
					],
				],
				'default'     => '',
				'selectors'            => [
					'{{WRAPPER}} .foodforlife-heading' => 'justify-content: {{VALUE}}; text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .foodforlife-heading' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'typography',
				'selector' => '{{WRAPPER}} .foodforlife-heading',
			]
		);
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', [ 'foodforlife-heading-elementor' ] );

		$this->add_render_attribute( 'title', 'class', [ 'foodforlife-heading', 'd-flex', 'align-items-center', 'my-0', 'foodforlife-heading--' . $settings['size'] ] );
		$this->add_render_attribute( 'icon', 'class', 'foodforlife-heading__icon' );
