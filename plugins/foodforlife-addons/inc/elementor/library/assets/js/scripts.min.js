;( function( elementor, $, window ) {
	...
	var TemplateLibraryCollectionView = Marionette.CompositeView.extend({
		...
		onRenderCollection: function onRenderCollection() {
			...
			if ('foodforlife_ext' === foodforlife_ext_templates_lib.templates.getFilter('source') && 'page' !== foodforlife_ext_templates_lib.templates.getFilter('type')) {
				this.setMasonrySkin();
			}
		},
	...
	elementor.on('document:loaded', function() {
		...
		var $templateLibBtnStyle = $( '<style />' ),
			btnStyle = '';
			btnStyle += '.elementor-add-section-area-button.foodforlife-ext-add-template-button { padding: 0; vertical-align: bottom; background-color: #004bef; }';
			btnStyle += '.elementor-add-section-area-button.foodforlife-ext-add-template-button img { height: 40px; }';
