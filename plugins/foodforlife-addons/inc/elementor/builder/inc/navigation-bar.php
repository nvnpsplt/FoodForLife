...
class Navigation_Bar {
	...
	public function __construct() {
		...
		add_action( 'foodforlife_after_site', array( $this, 'navigation_bar_content_builder' ), 50 );
	}

	public function enqueue_scripts() {
		if( ! apply_filters( 'foodforlife_get_navigation_bar_builder', true ) ) {
			return;
		}
    ...
    public function navigation_bar_content_builder() {
		...
		echo '<div id="foodforlife-mobile-navigation-bar" class="foodforlife-mobile-navigation-bar position-fixed start-0 end-0 bottom-0 bg-light shadow d-none-md">';
